...
extension Serialization {
  // 1024 is ideal for general purpose usage.
  //
  // We're using higher resolution here because of issues with quantization
  // jittering energies by ~0.01 eV. We can afford the tradeoff that maximum
  // possible volumes are now smaller.
  static let quantizationBinsPerNm: Float = 4096
  
  /*
   quantization resolution: 1 / 1024 nm
   
   before quantization:
   
   |       | H     | CHH   | SiHHH | HAbst |
   | ----- | ----: | ----: | ----: | ----: |
   | adamantane(.carbon)   |   5.353 eV |   5.183 eV |   3.908 eV |   6.004 eV |
   | carbosilane(.carbon)  |   5.193 eV |   5.163 eV |   3.783 eV |   5.904 eV |
   | adamantane(.silicon)  |   4.733 eV |   4.419 eV |   3.160 eV |   5.164 eV |
   | carbosilane(.silicon) |   4.764 eV |   4.406 eV |   3.153 eV |   5.200 eV |
   
   after quantization:
   
   |       | H     | CHH   | SiHHH | HAbst |
   | ----- | ----: | ----: | ----: | ----: |
   | adamantane(.carbon)   |   5.346 eV |   5.177 eV |   3.901 eV |   5.990 eV |
   | carbosilane(.carbon)  |   5.191 eV |   5.158 eV |   3.778 eV |   5.898 eV |
   | adamantane(.silicon)  |   4.733 eV |   4.413 eV |   3.156 eV |   5.155 eV |
   | carbosilane(.silicon) |   4.763 eV |   4.402 eV |   3.148 eV |   5.194 eV |
   */

  /*
   quantization resolution: 1 / 4096 nm
   
   before quantization:
   
   |       | H     | CHH   | SiHHH | HAbst |
   | ----- | ----: | ----: | ----: | ----: |
   | adamantane(.carbon)   |   5.353 eV |   5.179 eV |   3.903 eV |   6.000 eV |
   | carbosilane(.carbon)  |   5.193 eV |   5.160 eV |   3.780 eV |   5.901 eV |
   | adamantane(.silicon)  |   4.733 eV |   4.415 eV |   3.155 eV |   5.159 eV |
   | carbosilane(.silicon) |   4.764 eV |   4.402 eV |   3.149 eV |   5.195 eV |
   
   after quantization:
   
   |       | H     | CHH   | SiHHH | HAbst |
   | ----- | ----: | ----: | ----: | ----: |
   | adamantane(.carbon)   |   5.353 eV |   5.178 eV |   3.903 eV |   5.999 eV |
   | carbosilane(.carbon)  |   5.193 eV |   5.160 eV |   3.780 eV |   5.900 eV |
   | adamantane(.silicon)  |   4.733 eV |   4.414 eV |   3.155 eV |   5.159 eV |
   | carbosilane(.silicon) |   4.764 eV |   4.401 eV |   3.149 eV |   5.195 eV |
   */
  ...
  static func hash(atoms: [SIMD4<Float>]) -> Data {
    ...
    for atom in atoms {
      ...
      var quantized = atom
      quantized *= quantizationBinsPerNm
  ...
  static func serialize(atoms: [SIMD4<Float>]) -> Data {
    ...
    for atom in atoms {
      ...
      position *= quantizationBinsPerNm
...
extension Serialization {
  ...
  static func serialize(bonds: [SIMD2<UInt32>]) -> Data {
    ...
    for bond in bonds {
      // We rely on there always being a 16-compressed atom nearby.
